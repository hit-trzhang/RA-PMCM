...
(
    ...
    assign wire_2_37 = (reg_1_1<<5) + {reg_1_5, reg_1_1[1], reg_1_1[0]};
    ...
    assign wire_3_45 = (reg_2_1<<5) + {reg_2_13, reg_2_1[1], reg_2_1[0]};
    assign wire_3_53 = (reg_2_1<<4) + {reg_2_37, reg_2_13[2], reg_2_1[1], reg_2_1[0]};
    assign wire_3_61 = ({reg_2_13, reg_2_1[1], reg_2_1[0]}<<2) + {reg_2_9, reg_2_1[2], reg_2_1[1], reg_2_1[0]};
    assign wire_3_79 = (reg_2_1<<2) + {reg_2_75, reg_2_1[0]};
    assign wire_3_93 = ({reg_2_9, reg_2_1[2], reg_2_1[1], reg_2_1[0]}<<1) + {reg_2_75, reg_2_1[0]};
    assign wire_3_101 = (reg_2_1<<6) + {reg_2_37, reg_2_13[2], reg_2_1[1], reg_2_1[0]};
    ...
    assign wire_3_333 = ({reg_2_37, reg_2_13[2], reg_2_1[1], reg_2_1[0]}<<3) + {reg_2_37, reg_2_13[2], reg_2_1[1], reg_2_1[0]};
    assign wire_3_613 = ({reg_2_9, reg_2_1[2], reg_2_1[1], reg_2_1[0]}<<6) + {reg_2_37, reg_2_13[2], reg_2_1[1], reg_2_1[0]};
    assign wire_3_1097 = ({reg_2_17, reg_2_1[3], reg_2_1[2], reg_2_1[1], reg_2_1[0]}<<6) + {reg_2_9, reg_2_1[2], reg_2_1[1], reg_2_1[0]};
    assign wire_3_1197 = ({reg_2_37, reg_2_13[2], reg_2_1[1], reg_2_1[0]}<<5) + {reg_2_13, reg_2_1[1], reg_2_1[0]};
